...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20240520_maboutique_30989a6f20d2c0c47686_20240520234501_archive.zip';
        const ARCHIVE_SIZE       = '44916667';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '30989a6-20234501';
        const SECONDARY_PACKAGE_HASH = 'fb861ff-20234501';
        const VERSION            = '1.5.9';
